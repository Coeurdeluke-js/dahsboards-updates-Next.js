    ...
    <div className="min-h-screen bg-gradient-to-b from-[#212121] via-[#121212] to-[#212121] overflow-x-hidden pt-24 px-4">
      <section className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-[#1e1e1e] rounded-xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            <i className="fas fa-chalkboard-teacher text-4xl text-[#ec4d58] mb-4 block"></i>
          ...
          <div className="bg-[#1e1e1e] rounded-xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            <i className="fas fa-users text-4xl text-[#ec4d58] mb-4 block"></i>
          ...
          <div className="bg-[#1e1e1e] rounded-xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            <i className="fas fa-handshake text-4xl text-[#ec4d58] mb-4 block"></i>
