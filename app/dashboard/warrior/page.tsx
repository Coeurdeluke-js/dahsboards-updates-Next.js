...
export default function WarriorDashboard() {
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <header className="flex justify-between items-center mb-8 bg-green-800/10 p-4 rounded-lg">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">{user?.email || 'Warrior'}</h1>
            <p className="text-green-600">Rango: Warrior</p>
          </div>
        </div>
        <ThemeToggle />
      </header>
